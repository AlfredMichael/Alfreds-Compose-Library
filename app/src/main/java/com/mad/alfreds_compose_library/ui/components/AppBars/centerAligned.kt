...
fun CenterAlignedFullScreen(){
    ...
    Scaffold(
        // The top bar is set to the CenterAlignedAppBar() composable function that we've defined below.
...
// This composable represents a center aligned top app bar.
@Composable
fun CenterAligned(){
    // We call the CenterAlignedAppBar() composable function to display the top app bar.
    CenterAlignedAppBar()
}
...
// This is a preview of the CenterAlignedFullScreen composable in light theme.
@Preview(showBackground = true)
@Composable
fun CenterAlignedFullScreenPreview() {
    AlfredscomposelibraryTheme {
        CenterAlignedFullScreen()
    }
}


// This is a preview of the CenterAligned composable in light theme.
@Preview(showBackground = true)
@Composable
fun CenterAlignedPreview() {
    AlfredscomposelibraryTheme {
        CenterAligned()
    }
}
...
// This is a preview of the CenterAligned composable in dark theme.
@Preview
@Composable
fun CenterAlignedDarkPreview() {
